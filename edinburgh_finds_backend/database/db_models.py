...
class Venue(SQLModel, table=True):
    ...
    # RACQUET SPORTS
    # ===========================
    tennis_summary: Optional[str] = Field(
        default=None,
    ...
    padel_summary: Optional[str] = Field(
        default=None,
    ...
    pickleball_summary: Optional[str] = Field(
        default=None,
    ...
    badminton_summary: Optional[str] = Field(
        default=None,
    ...
    squash_summary: Optional[str] = Field(
        default=None,
    ...
    table_tennis_summary: Optional[str] = Field(
        default=None,
        description="A short overall description of the table_tennis facilities summarising all gathered data"
    )
    ...
    # FOOTBALL
    # ===========================
    football_summary: Optional[str] = Field(
        default=None,
        description="A short overall description of the football facilities summarising all gathered data"
    )
    football_5_a_side: Optional[bool] = Field(None)
    football_5_a_side_total_pitches: Optional[int] = Field(None, description="Total number of 5-a-side pitches.")
    football_7_a_side: Optional[bool] = Field(None)
    football_7_a_side_total_pitches: Optional[int] = Field(None, description="Total number of 7-a-side pitches.")
    football_11_a_side: Optional[bool] = Field(None)
    football_11_a_side_total_pitches: Optional[int] = Field(None, description="Total number of full-size 11-a-side pitches.")

    # ===========================
    # SWIMMING
    # ===========================
    swimming_summary: Optional[str] = Field(
        default=None,
    ...
    # GYM & CLASSES
    # ===========================
    gym_summary: Optional[str] = Field(
        default=None,
    ...
    classes_summary: Optional[str] = Field(
        default=None,
    ...
    # SPA & WELLNESS
    # ===========================
    spa_summary: Optional[str] = Field(
        default=None,
    ...
    # DINING & AMENITIES
    # ===========================
    amenities_summary: Optional[str] = Field(
        default=None,
    ...
    wifi: Optional[bool] = Field(None)

    # ===========================
    # FAMILY & KIDS
    # ===========================
    family_summary: Optional[str] = Field(
        default=None,
    ...
    # PARKING & TRANSPORT
    # ===========================
    parking_and_transport_summary: Optional[str] = Field(
        default=None,
