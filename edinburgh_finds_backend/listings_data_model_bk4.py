...
class LocationMixin(BaseModel):
    ...
    postcode: Optional[str] = Field(None, description="Full UK postcode (e.g., 'SW1A 0AA')")
...
class ContactMixin(BaseModel):
    phone: Optional[str] = Field(default=None, description="The primary, publicly-listed contact phone number for the venue (e.g., +44 20 7946 0000).")
    ...
    linkedin_url: Optional[str] = Field(default=None, description="The LinkedIn company page URL (more relevant for B2B/Corporate).")
